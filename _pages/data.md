...
In my dissertation, I advance a unified and theoretically informed measure of mass threats in autocracies. With a specific focus on two fundamental facets of mass threats, i.e., grievance and organizational capacity, I collect 13 observed indicators that have been thoughtfully selected to effectively capture the two facets. Utilizing a Bayesian dynamic latent variable approach, the model synthesizes information on the selected manifest indicators, generating time-series cross-sectional data of mass threats covering 122 authoritarian countries from 1960 to 2018.
